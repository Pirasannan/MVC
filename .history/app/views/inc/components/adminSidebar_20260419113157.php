<aside class="sidebar">
    ...
    <div class="sidebar-bottom">
        <?php $settings_active = isset($current_page) && $current_page === 'adminSettings' ? ' active' : ''; ?>
        ...
        <a href="<?php echo URLROOT; ?>/Pages/adminSettings" class="nav-item-bottom<?php echo $settings_active; ?>">
