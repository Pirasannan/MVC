<aside class="sidebar">
    ...
    <div class="sidebar-bottom">
        <a href="<?php echo URLROOT; ?>/Pages/patientSettings" class="nav-item-bottom" id="settingsBtn">
            <span class="nav-short" aria-hidden="true">S</span>
            <span class="nav-label">Settings</span>
        </a>
        <a href="<?php echo URLROOT; ?>/Users/logout" class="nav-item-bottom" id="logoutBtn">
