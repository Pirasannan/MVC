<aside class="sidebar">
    ...
    <div class="sidebar-bottom">
        <?php $settings_active = isset($current_page) && $current_page === 'patientSettings' ? ' active' : ''; ?>
        ...
        <a href="<?php echo URLROOT; ?>/Pages/patientSettings" class="nav-item-bottom<?php echo $settings_active; ?>">
