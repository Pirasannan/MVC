...
<div class="dashboard-container doctor">
    ...
    <main class="main-content">
        <!-- Top Header (matches Prescriptions tab) -->
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <?php
                                                        ...
                                                        // map to existing badge classes you use elsewhere
                                        ...
                                        <?php foreach ($data['approved'] as $a): ?>
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <?php
                                                        $mins = (int) round((strtotime($a->ends_at) - strtotime($a->starts_at)) / 60);
                                                        if ($mins > 0):
                                                    ?>
                                                ...
                                                <td class="text-right">
                                                    <div class="table-actions">
                                                        <!-- Dummy Start button; no backend wiring yet -->
