              ...
              <tr>
                ...
                <td>
                  ...
                  <?php elseif (strtolower($a->status) === 'approved'): ?>
                    <a href="<?php echo URLROOT; ?>/Pages/patientPrecall/<?php echo (int)$a->id; ?>" class="join-consultation-btn" style="display: inline-block; padding: 8px 16px; background: #4a90e2; color: white; text-decoration: none; border-radius: 4px; font-size: 14px; font-weight: 500;">
