  ...
  var initializeSidebarToggle = function () {
    ...
    if (!body || !hasSidebar) {
      if (body) {
        ...
        body.classList.remove('mobile-sidebar-enabled');
      }
      if (root) {
        root.classList.remove('sidebar-collapsed-persisted');
      }
      return;
    }

    body.classList.add('mobile-sidebar-enabled');
    ...
    var applyState = function (collapsed, persist) {
      ...
      if (root) {
        root.classList.toggle('sidebar-collapsed-persisted', collapsed);
      }
    ...
    if (root && root.classList.contains('sidebar-no-transition')) {
