...
$doctorAvatarUrl = $doctorAvatarPath !== '' ? URLROOT . '/' . $doctorAvatarPath : $defaultAvatarUrl;
?>
    ...
    <div class="precall-content">
        ...
        <div class="patient-info-card">
            <div class="patient-avatar">
                <img src="<?= htmlspecialchars($doctorAvatarUrl, ENT_QUOTES, 'UTF-8') ?>"
        ...
        <div class="media-setup">
            ...
            <div class="media-right-panel">
                ...
                <div class="precall-actions">
                    <a href="<?= URLROOT ?>/VideoCall/room/<?= $appointmentId ?>" class="join-consultation-btn" id="startCallBtn">
