...
<div class="dashboard-container doctor">
        ...
        <div class="dashboard-content">
            ...
            <div class="doctor-profile-layout">
                <div class="doctor-profile-card">
                    ...
                    <button type="button" class="action-button primary profile-edit-btn" id="open-doctor-profile-edit-modal-btn">Edit Profile</button>
                </div>
                ...
                <div class="doctor-details-card">
                    ...
                    <div class="details-table">
                        ...
                        <div class="details-row"><span>Doctor ID</span><span>#<?php echo htmlspecialchars($data['user_id']); ?></span></div>
                        <div class="details-row"><span>Role</span><span><span class="status-badge doctor">Doctor</span></span></div>
    ...
    <div class="modal-overlay <?php echo (!empty($data['profile_image_err']) || !empty($data['user_name_err']) || !empty($data['user_email_err'])) ? 'active' : ''; ?>" id="doctor-profile-edit-modal-overlay">
        <div class="modal-card" role="dialog" aria-modal="true" aria-labelledby="doctor-profile-edit-modal-title">
            <div class="modal-header">
                ...
                <button type="button" class="modal-close" id="close-doctor-profile-edit-modal-btn" aria-label="Close">&times;</button>
            </div>

            <form action="<?php echo URLROOT; ?>/Pages/doctorprofile" method="POST" enctype="multipart/form-data" class="modal-form upload-form">
                ...
                <div class="modal-field">
                    ...
                    <input type="file" id="doctor_profile_image" name="profile_image" class="profile-input" accept="image/jpeg,image/jpg,image/png" required>
                </div>
            ...
            <form action="<?php echo URLROOT; ?>/Pages/doctorprofile" method="POST" class="modal-form">
                ...
                <div class="modal-actions">
                    ...
                    <button type="button" class="action-button" id="cancel-doctor-profile-edit-modal-btn">Cancel</button>
                </div>
            </form>
        </div>
    </div>
