            ...
            <div class="patient-profile-layout">
                ...
                <div class="patient-details-card">
                    ...
                    <div class="details-table">
                        ...
                        <div class="details-row"><span>Patient
                                ID</span><span>#<?php echo htmlspecialchars($data['user_id']); ?></span></div>
                        <div class="details-row"><span>Account Status</span><span><span
                                    class="status-badge active">Active</span></span></div>
                        <div class="details-row"><span>Member Since</span><span><?php echo date('M Y'); ?></span></div>
                        <div class="details-row"><span>Blood
                                Type</span><span><?php echo !empty($data['medical_info']->blood_type) ? htmlspecialchars($data['medical_info']->blood_type) : '-'; ?></span>
                        </div>
                        <div class="details-row"><span>Date of
                                Birth</span><span><?php echo !empty($data['medical_info']->date_of_birth) ? htmlspecialchars($data['medical_info']->date_of_birth) : '-'; ?></span>
                        </div>
                        <div class="details-row"><span>Emergency
                                Contact</span><span><?php echo !empty($data['medical_info']->emergency_contact) ? htmlspecialchars($data['medical_info']->emergency_contact) : '-'; ?></span>
                        </div>
                        <div class="details-row"><span>Insurance
                                Provider</span><span><?php echo !empty($data['medical_info']->insurance_provider) ? htmlspecialchars($data['medical_info']->insurance_provider) : '-'; ?></span>
                        </div>
                        <div class="details-row">
                            <span>Allergies</span><span><?php echo !empty($data['medical_info']->allergies) ? nl2br(htmlspecialchars($data['medical_info']->allergies)) : '-'; ?></span>
                        </div>
                    </div>
                </div>
            </div>

            <div class="patient-details-card security-card full-width">
                ...
                <div class="security-info-grid">
                    <div class="security-item">
                        ...
                        <div class="security-text">
                            ...
                            <p>Update your password regularly to keep your health records and personal data safe from
                    ...
                    <div class="security-item">
                        ...
                        <div class="security-text">
                            <h4>Deactivate Personal Account</h4>
                            <p>Permanently deactivating your account will remove your access to MediLink. This action is
                                secure and requires OTP verification.</p>
                        </div>
...
<div class="modal-overlay" id="profile-edit-modal-overlay">
    <div class="modal-card" role="dialog" aria-modal="true" aria-labelledby="profile-edit-modal-title">
        <div class="modal-header">
            ...
            <button type="button" class="modal-close" id="close-profile-edit-modal-btn"
                aria-label="Close">&times;</button>
        </div>

        <form action="<?php echo URLROOT; ?>/Pages/patientProfile" method="POST" enctype="multipart/form-data"
        ...
        <form action="<?php echo URLROOT; ?>/Pages/patientProfile" method="POST" class="modal-form">
            ...
            <div class="modal-field">
                ...
                <input type="text" id="patient_user_name" name="user_name"
                    value="<?php echo htmlspecialchars($data['user_name']); ?>"
                    class="profile-input <?php echo !empty($data['name_err']) ? 'is-invalid' : ''; ?>" required>
            </div>
        ...
        <form action="<?php echo URLROOT; ?>/Pages/patientProfile" method="POST" class="modal-form"
            ...
            <div class="modal-field-row">
                ...
                <div class="modal-field">
                    ...
                    <input type="date" id="date_of_birth" name="date_of_birth" class="profile-input"
                        value="<?php echo htmlspecialchars($data['medical_form']['date_of_birth'] ?? ''); ?>">
                </div>
            </div>
            ...
            <div class="modal-field-row">
                <div class="modal-field">
                    ...
                    <input type="text" id="emergency_contact" name="emergency_contact" class="profile-input"
                        value="<?php echo htmlspecialchars($data['medical_form']['emergency_contact'] ?? ''); ?>"
                        placeholder="0771234567">
                </div>

                <div class="modal-field">
                    <label for="insurance_provider">Insurance Provider</label>
                    <input type="text" id="insurance_provider" name="insurance_provider" class="profile-input"
                        value="<?php echo htmlspecialchars($data['medical_form']['insurance_provider'] ?? ''); ?>"
            ...
            <div class="modal-field">
                ...
                <textarea id="allergies" name="allergies" class="profile-input textarea-input" rows="3"
                    placeholder="Enter allergies if any"><?php echo htmlspecialchars($data['medical_form']['allergies'] ?? ''); ?></textarea>
            </div>
