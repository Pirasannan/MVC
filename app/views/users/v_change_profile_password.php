<?php require APPROOT.'/views/inc/header.php'; ?>
    ...
    <div class="form_container">
        ...
        <form action="<?php echo URLROOT; ?>/Users/changeProfilePassword" method="POST" class="form" novalidate>
            ...
            <div class="account-links">
                <a class="create_acc" href="<?php echo URLROOT; ?>/Pages/<?php echo $_SESSION['user_role'] ?? 'index'; ?>Profile">← Cancel</a>
            </div>
