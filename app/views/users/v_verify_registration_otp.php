...
<div class="form_container">
    ...
    <p class="otp-page-title">Verify Your Account</p>
    ...
    <form action="<?php echo URLROOT; ?>/Users/verifyRegistrationOtp" method="POST" class="form" novalidate>
        ...
        <button type="submit" class="submit-button">Verify Registration</button>

        <div class="account-links">
            <a class="create_acc" href="<?php echo URLROOT; ?>/Users/register">← Back to Register</a>
            <a class="forgot_pass" href="<?php echo URLROOT; ?>/Users/register">Resend OTP</a>
        </div>
    ...
    (function () {
        ...
        function tick() {
            ...
            if (totalSeconds <= 0) {
                ...
                window.location.href = redirectTo; // ← hard redirect back to register step
                return;
            }
